      ...
      <header className="border-b bg-background">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link href="/sustainability-tracker" className="text-sm font-medium hover:underline underline-offset-4">
              Sustainability Tracker
            </Link>
            <Link href="/calculator" className="text-sm font-medium hover:underline underline-offset-4">
              Calculator
            </Link>
            <Link href="/challenges" className="text-sm font-medium hover:underline underline-offset-4">
              Challenges
            </Link>
            ...
            <Link href="/my-content" className="text-sm font-medium hover:underline underline-offset-4">
              My Content
            </Link>
          </nav>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    EcoWise helps you measure your carbon footprint, join sustainability challenges, and make a positive
